        ...
        <div
          ...
          <div
            ...
            <div className="text-sm text-gray-600 space-y-2">
              {property.city && property.province && (
                <p>
                  <span className="font-medium">مکان:</span> {property.city}،{" "}
                  {property.province}
                </p>
              )}
              ...
              {property.price && (
                <p>
                  <span className="font-medium">قیمت:</span> {property.price}
                </p>
              )}
              {property.status_label && (
                <p>
                  <span className="font-medium">وضعیت تأیید:</span>{" "}
                  <span
                    className={`inline-block px-2 py-1 text-xs font-medium rounded-full ${getStatusBadgeStyles(
                      property.status
                    )}`}>
                    {property.status_label}
                  </span>
