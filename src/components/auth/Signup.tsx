      ...
      <div className="flex h-screen pt-10 md:pt-0 w-full md:h-auto md:mt-10 bg-white/40 backdrop-blur-2xl md:rounded-lg shadow-lg overflow-hidden md:w-4xl md:mx-auto md:max-w-sm lg:max-w-4xl">
        ...
        <div className="w-full p-8 lg:w-1/2">
          ...
          <div className="w-full flex gap-2 mt-2">
            <span className="w-1/2 text-center text-sm cursor-pointer  text-white transition bg-blue-500 p-2 rounded-sm ">
              عضویت
            </span>
            <span
              onClick={() => dispatch(toggleAuth())}
              className="w-1/2 text-center text-sm cursor-pointer text-black transition bg-white p-2 rounded-sm ">
              ورود
            </span>
          </div>
